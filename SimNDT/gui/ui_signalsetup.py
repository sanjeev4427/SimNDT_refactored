...
class Ui_SignalSetupWidget(object):
    def setupUi(self, SignalSetupWidget):
        ...
        SignalSetupWidget.resize(240*scaleUI, 200*scaleUI)
        SignalSetupWidget.setMinimumSize(QtCore.QSize(240*scaleUI, 200*scaleUI))
        SignalSetupWidget.setMaximumSize(QtCore.QSize(240*scaleUI, 200*scaleUI))
        self.Frame = QtGui.QFrame(SignalSetupWidget)
        self.Frame.setGeometry(QtCore.QRect(10*scaleUI, 10*scaleUI, 221*scaleUI, 184*scaleUI))
