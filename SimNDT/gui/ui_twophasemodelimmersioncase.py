...
class Ui_twoPhaseModelImmersionCaseDialog(object):
    def setupUi(self, twoPhaseModelImmersionCaseDialog):
        ...
        twoPhaseModelImmersionCaseDialog.resize(476*scaleUI, 365*scaleUI)
        twoPhaseModelImmersionCaseDialog.setMaximumSize(QtCore.QSize(476*scaleUI, 365*scaleUI))
        ...
        self.buttonBox.setGeometry(QtCore.QRect(90*scaleUI, 330*scaleUI, 341*scaleUI, 32*scaleUI))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.frame = QtGui.QFrame(twoPhaseModelImmersionCaseDialog)
        self.frame.setGeometry(QtCore.QRect(20*scaleUI, 110*scaleUI, 441*scaleUI, 182*scaleUI))
        self.frame.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtGui.QFrame.Sunken)
        self.frame.setObjectName("frame")
        self.gridLayoutWidget = QtGui.QWidget(self.frame)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10*scaleUI, 10*scaleUI, 421*scaleUI, 162*scaleUI))
        ...
        self.frame_2.setGeometry(QtCore.QRect(20*scaleUI, 10*scaleUI, 441*scaleUI, 91*scaleUI))
        self.frame_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.frame_2.setObjectName("frame_2")
        self.gridLayoutWidget_2 = QtGui.QWidget(self.frame_2)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10*scaleUI, 10*scaleUI, 411*scaleUI, 71*scaleUI))
