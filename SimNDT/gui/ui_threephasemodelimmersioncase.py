...
class Ui_threePhaseModelImmersionCaseDialog(object):
    def setupUi(self, threePhaseModelImmersionCaseDialog):
        ...
        threePhaseModelImmersionCaseDialog.resize(473*scaleUI, 576*scaleUI)
        threePhaseModelImmersionCaseDialog.setMaximumSize(QtCore.QSize(473*scaleUI, 576*scaleUI))
        self.buttonBox = QtGui.QDialogButtonBox(threePhaseModelImmersionCaseDialog)
        self.buttonBox.setGeometry(QtCore.QRect(90*scaleUI, 540*scaleUI, 341*scaleUI, 32*scaleUI))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.progressBar = QtGui.QProgressBar(threePhaseModelImmersionCaseDialog)
        self.progressBar.setGeometry(QtCore.QRect(30*scaleUI, 510*scaleUI, 411*scaleUI, 23*scaleUI))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.groupBox = QtGui.QGroupBox(threePhaseModelImmersionCaseDialog)
        self.groupBox.setGeometry(QtCore.QRect(10*scaleUI, 110*scaleUI, 451*scaleUI, 221*scaleUI))
        ...
        self.frame.setGeometry(QtCore.QRect(10*scaleUI, 30*scaleUI, 441*scaleUI, 181*scaleUI))
        self.frame.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtGui.QFrame.Sunken)
        self.frame.setObjectName("frame")
        self.gridLayoutWidget = QtGui.QWidget(self.frame)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10*scaleUI, 10*scaleUI, 419*scaleUI, 162*scaleUI))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10*scaleUI, 340*scaleUI, 451*scaleUI, 171*scaleUI))
        self.groupBox_2.setFlat(True)
        self.groupBox_2.setObjectName("groupBox_2")
        self.frame_2 = QtGui.QFrame(self.groupBox_2)
        self.frame_2.setGeometry(QtCore.QRect(10*scaleUI, 30*scaleUI, 441*scaleUI, 131*scaleUI))
        self.frame_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.frame_2.setObjectName("frame_2")
        self.gridLayoutWidget_2 = QtGui.QWidget(self.frame_2)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10*scaleUI, 10*scaleUI, 419*scaleUI, 111*scaleUI))
        ...
        self.frame_3.setGeometry(QtCore.QRect(10*scaleUI, 10*scaleUI, 451*scaleUI, 91*scaleUI))
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(20*scaleUI, 10*scaleUI, 411*scaleUI, 71*scaleUI))
