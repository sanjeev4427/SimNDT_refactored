...
class Ui_NewModel(object):
    def setupUi(self, NewModel):
        ...
        NewModel.resize(272*scaleUI, 200*scaleUI)
        NewModel.setMinimumSize(QtCore.QSize(272*scaleUI, 200*scaleUI))
        NewModel.setMaximumSize(QtCore.QSize(272*scaleUI, 200*scaleUI))
        ...
        self.buttonBox.setGeometry(QtCore.QRect(40*scaleUI, 160*scaleUI, 201*scaleUI, 32*scaleUI))
        self.buttonBox.setMaximumSize(QtCore.QSize(300*scaleUI, 300*scaleUI))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setCenterButtons(True)
        self.buttonBox.setObjectName("buttonBox")
        self.formLayoutWidget = QtGui.QWidget(NewModel)
        self.formLayoutWidget.setGeometry(QtCore.QRect(40*scaleUI, 20*scaleUI, 191*scaleUI, 131*scaleUI))
        ...
        self.pixelLineEdit.setMaximumSize(QtCore.QSize(80*scaleUI, 16777215))
        ...
        self.labelSpinBox.setMinimumSize(QtCore.QSize(80*scaleUI, 0))
        self.labelSpinBox.setMaximumSize(QtCore.QSize(80*scaleUI, 16777215))
