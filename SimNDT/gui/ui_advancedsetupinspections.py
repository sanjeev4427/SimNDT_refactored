...
class Ui_advancedSetupDialog(object):
    def setupUi(self, advancedSetupDialog):
        ...
        advancedSetupDialog.resize(273*scaleUI, 204*scaleUI)
        advancedSetupDialog.setMinimumSize(QtCore.QSize(273*scaleUI, 204*scaleUI))
        advancedSetupDialog.setMaximumSize(QtCore.QSize(273*scaleUI, 204*scaleUI))
        icon = QtGui.QIcon()
        ...
        self.buttonBox.setGeometry(QtCore.QRect(80*scaleUI, 170*scaleUI, 183*scaleUI, 32*scaleUI))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.groupBox = QtGui.QGroupBox(advancedSetupDialog)
        self.groupBox.setGeometry(QtCore.QRect(10*scaleUI, 10*scaleUI, 251*scaleUI, 151*scaleUI))
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayoutWidget = QtGui.QWidget(self.groupBox)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(9*scaleUI, 30*scaleUI, 232*scaleUI, 41*scaleUI))
        ...
        self.waveSourceComboBox.setGeometry(QtCore.QRect(10*scaleUI, 80*scaleUI, 231*scaleUI, 26*scaleUI))
        ...
        self.sourceTypeComboBox.setGeometry(QtCore.QRect(10*scaleUI, 110*scaleUI, 231*scaleUI, 26*scaleUI))
